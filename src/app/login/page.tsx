        ...
        <div className="grid flex-1 items-center gap-12 py-10 lg:grid-cols-2">
          <div className="hidden flex-col gap-6 lg:flex">
            ...
            <p className="max-w-md text-base text-slate-600">
              Pick up where you left off. Your conversations and uploaded
              documents are private to your workspace.
            </p>
            <ul className="space-y-3 text-sm text-slate-600">
              {[
                "Resume any thread with full context",
                "Switch document context per question",
                "Activity dashboard with stats and recent chats",
              ].map((line) => (
